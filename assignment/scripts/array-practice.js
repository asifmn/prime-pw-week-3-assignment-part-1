...
console.log('Number of foods:', favFoodsArray.length);
...
favFoodsArray.push('mocha');
console.log('Added a food to end,', favFoodsArray);
...
console.log('The foods are now', favFoodsArray);
...
favFoodsArray.unshift('ice cream');
console.log(`Added a food to beginning: ${favFoodsArray}`);
